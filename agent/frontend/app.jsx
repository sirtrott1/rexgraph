...
function Pipeline(){
  ...
  return h("div",null,h("h2",null,"Pipeline"),
    h(Card,{title:"Upload & Analyze"},
      ...
      h("div",{className:"muted",style:{fontSize:11,marginBottom:6}},"Auto-detects the input: tables (CSV/TSV), records (JSON), edge lists, text, and pre-built complexes (.safetensors/.rcbd/.parquet) are read by format. OCR runs only for images & PDFs."),
    ...
    tab==="corpus"&&h("div",null,
      ...
      h("div",{className:"input-row",style:{marginTop:-4,marginBottom:8}},
        h("button",{className:pasteOpen?"sm primary":"sm",onClick:function(){setPasteOpen(!pasteOpen)}},
          "Paste text instead"),
        pasteOpen?h(Help,null,"Text becomes a complex the same way an uploaded file does: words are vertices, sentences relate them. It is written as a .rcbd that carries the text, so the document is one file."):null),
  ...
  return h(TplReport,{title:"System"},h(Err,{msg:err}),
    ...
    tab==="workspace"&&h("div",null,
      wksp&&h(Card,{title:"Workspace: "+(wksp.name||"default")},
        ...
        h("div",{className:"input-row",style:{marginTop:12}},h("button",{className:"sm",onClick:function(){exportWs("json")}},"Export JSON"),h("button",{className:"sm",onClick:function(){exportWs("rex")}},"Export .rcbd"),h("button",{className:"sm",onClick:refreshWs},"Refresh"))),
  ...
  return h(TplReport,{title:h("span",{className:"lbl-help"},"Model Studio",h(Help,null,"A star marks the RexGraph-native component, which is the default. Any standard PyTorch option can be selected instead."))},h(Err,{msg:err}),
    ...
    h(Card,{title:"Build & train"},
      ...
      selA&&h("div",{className:"input-row",style:{marginTop:10}},
        h("input",{className:"input",style:{flex:2},value:dpath,onChange:function(e){setDp(e.target.value)},placeholder:"data path (parquet/.rcbd/csv/…, blank = synthetic)"}),
