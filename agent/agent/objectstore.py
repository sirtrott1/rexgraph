"""
agent.objectstore: compatibility surface for the sibling rcdb package.
...
and sixty-odd test files that import `agent.objectstore` keep working unchanged.
...
"""
from rcdb import objectstore as _source
