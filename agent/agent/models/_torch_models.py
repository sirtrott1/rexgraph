"""The archetype models themselves, which are torch modules.
...
Reached only through `archetypes`' build callables, which import this on call.
"""
...
from . import data as _data  # noqa: F401  (kept beside the models it shapes data for)
