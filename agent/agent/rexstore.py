"""
agent.rexstore: compatibility surface for the sibling rcdb package.
...
and sixty-odd test files that import `agent.rexstore` keep working unchanged.
...
"""
from rcdb import rexstore as _source
