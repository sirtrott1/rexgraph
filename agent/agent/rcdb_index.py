"""
agent.rcdb_index: compatibility surface for the sibling rcdb package.
...
and sixty-odd test files that import `agent.rcdb_index` keep working unchanged.
...
"""
from rcdb import index as _source
